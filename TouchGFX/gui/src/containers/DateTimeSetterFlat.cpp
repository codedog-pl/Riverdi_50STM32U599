...
void DateTimeSetterFlat::initialize()
{
    DateTimeSetterFlatBase::initialize();
...
void DateTimeSetterFlat::setValue(DateTime &value)
{
...
void DateTimeSetterFlat::yearWheelUpdateItem(DateTimeSetter4DigitsN &item, int16_t itemIndex)
{
    item.setValue(yearMin + itemIndex);
}

void DateTimeSetterFlat::monthWheelUpdateItem(DateTimeSetter2DigitsN &item, int16_t itemIndex)
{
    item.setValue(itemIndex + 1);
}

void DateTimeSetterFlat::dayWheelUpdateItem(DateTimeSetter2DigitsN &item, int16_t itemIndex)
{
    item.setValue(itemIndex + 1);
}

void DateTimeSetterFlat::hourWheelUpdateItem(DateTimeSetter2DigitsN &item, int16_t itemIndex)
{
    item.setValue(itemIndex);
}

void DateTimeSetterFlat::minuteWheelUpdateItem(DateTimeSetter2DigitsN &item, int16_t itemIndex)
{
    item.setValue(itemIndex);
}

void DateTimeSetterFlat::secondWheelUpdateItem(DateTimeSetter2DigitsN &item, int16_t itemIndex)
{
    item.setValue(itemIndex);
}
void DateTimeSetterFlat::yearWheelItemSelectedHandler(int16_t itemSelected)
{
...
void DateTimeSetterFlat::monthWheelItemSelectedHandler(int16_t itemSelected)
{
...
void DateTimeSetterFlat::dayWheelItemSelectedHandler(int16_t itemSelected)
{
    currentSetting.day = 1 + itemSelected;
    emitValueChangedCallback(currentSetting);
}

void DateTimeSetterFlat::hourWheelItemSelectedHandler(int16_t itemSelected)
{
    currentSetting.hour = static_cast<uint8_t>(itemSelected);
    emitValueChangedCallback(currentSetting);
}

void DateTimeSetterFlat::minuteWheelItemSelectedHandler(int16_t itemSelected)
{
    currentSetting.minute = static_cast<uint8_t>(itemSelected);
    emitValueChangedCallback(currentSetting);
}

void DateTimeSetterFlat::secondWheelItemSelectedHandler(int16_t itemSelected)
{
